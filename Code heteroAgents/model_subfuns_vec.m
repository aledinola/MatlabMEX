function [val,V,Policy,StatDist] = model_subfuns_vec(p_eqm, a_grid, z_grid, pi_z, Params,vfoptions,simoptions,heteroagentoptions)

% fun_VFI_parfor uses parfor native Matlab
[V,Policy,Params] = fun_VFI_vec(p_eqm, a_grid, z_grid, pi_z,Params,vfoptions) ;
