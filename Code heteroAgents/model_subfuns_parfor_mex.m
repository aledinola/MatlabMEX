function [val,V,Policy,StatDist] = model_subfuns_parfor_mex(p_eqm, a_grid, z_grid, pi_z, Params,vfoptions,simoptions,heteroagentoptions)

% the VFI should be compiled into CUDA
[V,Policy,Params] = fun_VFI_parfor_mex(p_eqm, a_grid, z_grid, pi_z,Params,vfoptions) ;
