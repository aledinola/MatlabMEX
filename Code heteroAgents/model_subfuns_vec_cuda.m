function [val,V,Policy,StatDist] = model_subfuns_vec_cuda(p_eqm, a_grid, z_grid, pi_z, Params,vfoptions,simoptions,heteroagentoptions)

[V,Policy,Params] = fun_VFI_vec_cuda_mex(p_eqm, a_grid, z_grid, pi_z,Params,vfoptions) ;
