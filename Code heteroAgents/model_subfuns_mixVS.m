function [val,V,Policy,StatDist] = model_subfuns_mixVS(p_eqm, a_grid, z_grid, pi_z, Params, vfoptions, simoptions, heteroagentoptions)

% the VFI should be compiled into CUDA
% [V,Policy,Params] = fun_VFI_cuda_mex(p_eqm, a_grid, z_grid, pi_z,Params,vfoptions) ;
[ReturnMatrix,Params,time_ret] = fun_return_cudaVS_mex(p_eqm, a_grid, z_grid, Params, vfoptions) ;

[V, Policy] = fun_VFIonly_parforVS_mex(a_grid, z_grid, pi_z, Params, vfoptions, ReturnMatrix, time_ret) ;
