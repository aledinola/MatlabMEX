 ...
 *
 * rbc_solver_interp_emxutil.c
 *
 * Code generation for function 'rbc_solver_interp_emxutil'
 *
 */
...
{
  emxFree_real_T(sp, &pStruct->k);
  emxFree_real_T(sp, &pStruct->EV_z);
}
...
void emxInitStruct_struct_T(const emlrtStack *sp, struct_T *pStruct,
                            const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->k, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->EV_z, 1, srcLocation);
}
...
/* End of code generation (rbc_solver_interp_emxutil.c) */
